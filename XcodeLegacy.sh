...
xc3=`expr $compilers + $osx104 + $osx105 + $osx106 != 0`
...
case $1 in
    buildpackages)
        ...
        if [ $xc3 = 1 -a ! -f xcode_3.2.6_and_ios_sdk_4.3.dmg ]; then
        ...
        if [ $xc4 = 1 -a  ! -f xcode4630916281a.dmg ]; then
        ...
        if [ $xc5 = 1 -a ! -f xcode_5.1.1.dmg ]; then
        ...
        if [ $xc6 = 1 -a ! -f Xcode_6.4.dmg ]; then
